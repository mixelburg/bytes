...
import { CenterState, Mono, SectionLabel } from '../components/ui';
import { money } from '../data/format';
import { NotFoundError, useOrder } from '../data/queries';
      ...
      >
        ...
        >
          <Box>
            ...
            <Box
              sx={{ fontFamily: mono, fontSize: 22, fontWeight: 600, mt: 0.25 }}
            >
              {fmtTime(data.eta)}
            </Box>
          </Box>
        ...
        <Box
          sx={{ mt: 1, border: '1px solid', borderColor: 'divider', p: 1.5 }}
        >
