...
Search input and category selection SHALL drive the API query, not client-side filtering. The category list SHALL be sourced from `GET /categories` (plus an "All" option) rather than hardcoded.
